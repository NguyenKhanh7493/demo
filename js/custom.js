(function($){
  ...
  // Preloader 
	...
	// CountDown Js
		var firstDay = 'September 2 2011 20:00:00 GMT+7';

		function time_remaining(firstDay) {
			var t = Date.parse(new Date()) - Date.parse(firstDay);
		...
		function run_clock(id, firstDay) {
